...
void selectTouch()
{
 TS_Point p = ts.getPoint();
      ...
      if((p.x>3500)&& p.y<800)
      {
        ...
        displayTs();
        displayMode();
       Serial.println("Mode CW touched");
      }
      ...
      if((p.x<3200)&&(p.x>2800)&&(p.y<800))
      {
        ...
        displayTs();
        displayMode();
        Serial.println("Mode LSB touched");
      }
      ...
      if((p.x<2700)&&(p.x>2300)&&(p.y<800))
      {
        ...
        displayTs();
        displayMode();
        Serial.println("Mode USB touched");
      }
      ...
      if((p.x<2000)&&(p.x>1600)&&(p.y<800))
      {
        Step=1000;
        displayTs();  
        Serial.println("Step 1000 Hz touched");
      }
      if((p.x<1400)&&(p.x>800)&&(p.y<800))
      {
        Step=100;
        displayTs();
        Serial.println("Step 100 Hz touched");
      }
      if((p.x<700)&&(p.y<800))
      {
        Step=1;
        displayTs();
        Serial.println("Step 1Hz touched");
      }
